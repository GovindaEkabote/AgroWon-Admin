...
const ProductUpload = () => {
  ...
  const onChangeFile = (e,apiEndPoint) =>{
    try {
      ...
      for(var i=0;i<files.length;i++){
        const file = files[i];
        imaArr.push(file);
        fb.append(`images`,file)
      }
      setFiles(imaArr);
      postData(apiEndPoint,fb).then((res) =>{
        console.log(res);
  ...
  const addProduct = (e) => {
    e.preventDefault();
    fb.append('name',formFields.name);
    fb.append('description',formFields.description);
    fb.append('category',formFields.category);
    fb.append('subCategory',formFields.subCategory);
    fb.append('price',formFields.price);
    fb.append('oldPrice',formFields.oldPrice);
    fb.append('isFeatured',formFields.isFeatured);
    fb.append('countInStock',formFields.countInStock);
    fb.append('discount',formFields.discount);
    fb.append('weight',formFields.weight);
    fb.append('quantity',formFields.quantity);
    fb.append('rating',formFields.rating);
    fb.append('brand',formFields.brand);
    // fb.append('images',formFields.images);
        ...
        <form className="form" onSubmit={addProduct}>
          ...
          <div className="card p-4 mt-0">
            <div className="imagesUpload">
              ...
              <br />
              <div className="imagesUploadBox d-flex align-items-center">
                <div className="uploadBox">
                  <img
                    src="https://res.cloudinary.com/dnuxiy4lw/image/upload/v1741614904/gllnrh6heqwnghv7ke8v.jpg"
                    className="w-100"
                  />
                </div>
                <div className="uploadBox">
                ...
                <div className="uploadBox">
                  <input
                    type="file"
                    multiple
                    onChange={(e) => onChangeFile(e, "/api/v1/products/upload")}
                    name="images"
                  />
                  <div className="info">
                    <MdDriveFolderUpload />
